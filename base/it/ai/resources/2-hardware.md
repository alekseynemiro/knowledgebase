...
Существует два основных направления работы с большими языковыми моделями (LLM): **[Inference](/it/ai/llm/glossary.md)** (генерация, вывод) и **[Fine-Tuning](/it/ai/llm/glossary.md)** (тонкая настройка, обучение).
...
[llama.cpp](/it/ai/llm/llama-cpp) позволяет использовать процессор (**CPU**) и оперативную память (**RAM**), если ресурсов графического процессора (**GPU**) недостаточно.
